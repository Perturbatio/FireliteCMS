...
/**
 * The Simpletext editor is a single line input
 * 
 */
class Simpletext extends FireliteBaseEditor {
	...
	static public function render($name, $data, $params = array()){
		...
		$response = Event::until('firelite.editor.simpletext.render:before', $event_data);
		...
		Event::fire('firelite.editor.simpletext.render:after', $event_data);
		return $res;
	}
