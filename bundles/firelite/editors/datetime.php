...
/**
 * The Datetime editor is a single line input
 * 
 */
class Datetime extends FireliteBaseEditor {
	...
	static public function render($name, $data, $params = array()){
		...
		$response = Event::until('firelite.editor.datetime.render:before', $event_data);
		...
		Event::fire('firelite.editor.datetime.render:after', $event_data);
		return $res;
	}
	...
	static public function firelite_description(){
		return 'Allows editing of datetime values';
	}
}